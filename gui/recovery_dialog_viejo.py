...
class RecoveryDialog(QDialog):
    ...
    """
    def __init__(self, parent, usuario_obj: Usuario, usuario=None):
        super().__init__(parent)
        self.usuario_actual = usuario

        # --- GUARDA INTERNA ---
        from utils.permisos import tiene_permiso_codigo

        CODIGO_PERMISO = "0350 Recuperar acceso (blanqueo contraseña)"
        ...
        # Si el usuario no tiene permiso explícito en la DB…
        if not tiene_permiso_codigo(usuario, CODIGO_PERMISO):
